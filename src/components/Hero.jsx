...
export default function Hero() {
  return (
    <section className="relative h-[90vh] w-full overflow-hidden">
      ...
      {/* subtle gradient edges to improve text contrast without blocking the scene */}
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl flex-col items-center justify-center px-6 text-center">
        ...
        >
          <a
            href="#projects"
            className="group rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-6 py-3 font-medium text-emerald-300 transition hover:bg-emerald-500/20"
          >
            View Projects
          </a>
          <a
            href="#contact"
            className="group rounded-xl border border-white/20 bg-white/5 px-6 py-3 font-medium text-white transition hover:bg-white/10"
          >
            Contact
          </a>
        </motion.div>
